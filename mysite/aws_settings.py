...
# DEFAULT_FROM_EMAIL = 'Sielegans-webplatform'
...
DEFAULT_FILE_STORAGE = 'siteLogic.s3storage.s3utils.MediaS3BotoStorage' 
STATICFILES_STORAGE =  'siteLogic.s3storage.s3utils.StaticS3BotoStorage' 
...
U_LOGFOLDER = '/var/log/django/'    
U_LOGFILE_NAME = 'django.log'
