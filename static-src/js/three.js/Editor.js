...
var Editor = function () {
	...
	this.signals = {
		...
		wormYChanged: new SIGNALS.Signal(),
		wormXChanged: new SIGNALS.Signal(),
		wormAngleChanged: new SIGNALS.Signal(),
		
		obstacleYChanged: new SIGNALS.Signal(),
		obstacleXChanged: new SIGNALS.Signal(),
		
		cubeSide1Changed: new SIGNALS.Signal(),
		cubeSide2Changed: new SIGNALS.Signal(),
		cubeDepthChanged: new SIGNALS.Signal(),
		
		cylinderLengthChanged: new SIGNALS.Signal(),
		cylinderRadiusChanged: new SIGNALS.Signal(),
		
		prismDepthChanged: new SIGNALS.Signal(),
		prismSideChanged: new SIGNALS.Signal(),
